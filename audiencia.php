...
$consulta = "SELECT id, juicio, fecha, tipo, comentarios FROM audiencia";
...
$insertar="INSERT INTO audiencia
                (juicio, fecha, tipo, comentarios) VALUES('$juicio','$fecha','$tipo','$comentarios')";
...
<form class="form-horizontal proyecto-container proyecto-login-form-22 margin-bottom-30" role="form"  method="post" action="audiencia.php">
    ...
    <h1><p>Detalle de audiencias</p></h1>
                            <p><br></p>
                                </div>
                   </div>
    </div>
                        ...
                        <tbody>
                          <?php $resultado = mysqli_query($conexion, $consulta);
                            ...
                            <tr>
                                ...
                                <td>
 &nbsp;&nbsp;&nbsp;&nbsp;  
<a href ="audiencia.php?ide=<?php echo $row["id"]; ?>">  <input type="submit" value="eliminar" name="eliminar" class="btn btn-success"> </a></td>
...
include_once("conexion2.php");
$ide=$_GET['ide'];
$eliminar="delete from audiencia where id='$ide'";
