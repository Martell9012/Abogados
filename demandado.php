...
$consulta = "SELECT id, nombre, direccion, particular, movil, correo, notas FROM demandado";
...
$insertar="INSERT INTO demandado
...
<form class="form-horizontal proyecto-container proyecto-login-form-22 margin-bottom-30" role="form"  method="post" action="demandado.php">
    ...
    <h1><p>Detalle de Demandado</p></h1>
                            <p><br></p>
                                </div>
                   </div>
    </div>
<table width=100%>
    ...
    <td>
        <center>
<img src="img/d.jpg" width="150" st>
</center>
</td>
</tr>
<tr>
                        ...
                        <tbody>
                          <?php $resultado = mysqli_query($conexion, $consulta);
                            ...
                            <tr>
                                ...
                                <td>
 &nbsp;&nbsp;&nbsp;&nbsp;  
<a href ="demandado.php?ide=<?php echo $row["id"]; ?>">  <input type="submit" value="eliminar" name="eliminar" class="btn btn-success"> </a></td>
...
include_once("conexion2.php");
$ide=$_GET['ide'];
$eliminar="delete from demandado where id='$ide'";
